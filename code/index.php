    ...
    <div class="wrapper indexPage">
        <div class="mainSection">
            <div class="logoContainer">
                <img src="https://www.google.com/logos/doodles/2021/seasonal-holidays-2021-6753651837109324.3-ladc.gif" alt="Google logo">
            </div>
                        ...
                        <div class="searchContainer">
                            ...
                            <div class="subcontainer">
                                <div class="search-icon">
                                    <div class="searh-icon-container">
                                        <span class="span span1 span2">
                                ...
                                <div class="input-container">
                                    ...
                                    <input type="text" class="input" maxlength="2048" name="term">
                                </div>
                                <div class="mic-container">
                                    <div class="mic-subcontainer">
                                        <svg class="svg">
